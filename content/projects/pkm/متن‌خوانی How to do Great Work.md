...
> [!NOTE] مقدمه
> متن How to do Great Work یا همان «چطور کار بزرگ انجام دهیم؟» بهترین متنی است که دربارهٔ کار کردن و انتخاب مسیر شغلی خوانده‌ام. نویسندهٔ متن، پاول گراهام، بنیان‌گذار شتاب‌دهندهٔ [Y Combinator](https://www.ycombinator.com/about) و از یکی از باتجربه‌ترین و خرمندترین انسان‌های روزگار است. هدف او از نوشتن این متن طولانی، تهیهٔ فهرستی از تکنیک‌های عالی کار کردن -مستقل از حوزهٔ کاری- است. همین باعث می‌شود که هر مخاطبی با آن ارتباط بگیرد و پس از خواندن متن، چند نکته‌ای برای مسیر خود بردارد. 
> 
