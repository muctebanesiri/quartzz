...
کمی دقیق‌تر شویم و مثال ببینیم. «الگوریتم‌های حل مسألهٔ تکرارشونده» یکی از نمودهای ریاضی این طرز نگاه هستند. در زیست‌شناسی، تکامل یکی از این الگوریتم‌هاست که با جهش‌های تصادفی، آزمایش می‌کند که آیا راه حل بهتری هست یا خیر. در فیزیک و شیمی، فرآیند آنیلینگ[^1] رفتار مشابهی دارد. منطق همهٔ آن‌ها این است که با یک جواب اولیه شروع کنیم و مدام تلاش کنیم که به به سمت حالتی بهتر از جواب فعلی حرکت کنیم. در علم جبر خطی، مسائلی به اسم برنامه‌ریزی خطی[^2] را با الگوریتم‌های تکرارشونده حل می‌کنند. مسألهٔ زیر را در نظر بگیرید:
