...
نظریه‌ها لنزهایی هستند که در دیدن واقعیت به ما کمک می‌کنند. البته که در صورت بی‌احتیاطی، باعث محدود abj
...
[نظریهٔ سیستم](https://en.wikipedia.org/wiki/Systems_theory): اجزاء یک کل منسجم می‌سازند که بیشتر از جمع تک‌تک اجزاست. ترجمهٔ ساختارگرایی در علوم مهندسی است. بخش [[مدخل × نظریهٔ سیستم|نظریهٔ سیستم]] در این سایت
...
### پروژهٔ شبیه‌سازی بیماری ([دمو](http://eledah.ir/disEase))
...
❗ این پروژه حتی شروع هم نشده و هنوز داخل ذهنم است.
